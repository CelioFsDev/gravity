...
class _InitialSetupScreenState extends ConsumerState<InitialSetupScreen>
  ...
  Future<void> _importZip() async {
    ...
    if (result != null && result.files.single.path != null) {
      ...
      try {
        ref.read(syncProgressProvider.notifier).startSync('Preparando ambiente offline...');
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            _buildInstructionStep(
                              ...
                              subtitle: 'Geralmente gerado pelo seu aparelho anterior ou portal web.',
                            ...
                            _buildInstructionStep(
                              ...
                              subtitle: 'Suas fotos e produtos ficarão disponíveis instantaneamente offline.',
                              icon: Icons.bolt_rounded,
                            ),
                            const SizedBox(height: 48),
                            FilledButton.icon(
                              onPressed: syncProgress.isSyncing ? null : _importZip,
                            ...
                            const SizedBox(height: 24),
                            TextButton(
                              onPressed: syncProgress.isSyncing ? null : _markAsCompletedAndProceed,
                              style: TextButton.styleFrom(
                                padding: const EdgeInsets.symmetric(vertical: 16),
                                foregroundColor: isDark ? Colors.white54 : Colors.black54,
                              ),
                              child: const Text('Começar do Zero (Catálogo Vazio)'),
                            ),
                          ],
                        ),
                      ),
