...
## Visão geral
CatalogoJa é um painel administrativo e vitrine pública focado em catálogos digitais. A base do app é em Flutter 3.10 + Riverpod, combinando armazenamento local (Hive) com Firebase Auth para permitir controle de acesso, métricas e compartilhamento via web/WhatsApp mesmo sem conexão cheia.
...
- O link público segue o padrão /c/{shareCode} e usa AppSettings.publicBaseUrl (ou https://CatalogoJa.app) para montar a URL.
